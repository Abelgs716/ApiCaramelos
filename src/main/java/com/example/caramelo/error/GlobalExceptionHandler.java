package com.example.caramelo.error;
...
import com.example.caramelo.dto.response.error.ErrorDetailsResponse;
...
public class GlobalExceptionHandler {
	 ...
	 * @return
	 */
	@ExceptionHandler(CarameloNotFoundException.class)
	public ResponseEntity<ErrorDetailsResponse> handleCarameloNotFoundException(CarameloNotFoundException ex,
			WebRequest request) {
		ErrorDetailsResponse errorDetails = new ErrorDetailsResponse(new Date(), ex.getMessage(),
				request.getDescription(false));
